...
public class NVPAPICaller
{
    ...
    public string APIUsername = "patrick.pheme1-facilitator_api1.gmail.com";
    private string APIPassword = "1404741783";
    private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31ALpSzl0ImtK6W44zPMq9QutoRAkE";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "http://localhost:49795/Checkout/CheckoutReview.aspx";
        string cancelURL = "http://localhost:49795/Checkout/CheckoutCancel.aspx";
        ...
        // Get the Shopping Cart Products the code I seee
    ...
    public string HttpCall(string NvpRequest)
    {
       ...
       /* string strPost = NvpRequest + "&" + buildCredentialsNVPString();
        ...
        HttpWebResponse objResponse = (HttpWebResponse)objRequest.GetRequestStream();
