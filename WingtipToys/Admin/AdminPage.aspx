...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Admin/AdminOrders.aspx">Orders</asp:HyperLink><a href="WebForm2.aspx">WebForm2.aspx</a>
    <hr />
    <h3>Add Product:</h3>
    <table>
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownAddCategory" runat="server" 
                    ...
                    DataValueField="CategoryID" Height="32px" Width="162px" BackColor="White" ForeColor="Black" >
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="AddProductName" runat="server" BorderColor="White" ForeColor="Black"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="AddProductDescription" runat="server" BackColor="White"></asp:TextBox>
        ...
        <tr>
            <td style="height: 25px"><asp:Label ID="LabelAddPrice" runat="server">Price:</asp:Label></td>
            <td style="height: 25px">
                <asp:TextBox ID="AddProductPrice" runat="server" BackColor="White" ForeColor="Black"></asp:TextBox>
    ...
    <table>
        <tr>
            ...
            <td><asp:DropDownList ID="DropDownRemoveProduct" runat="server" ItemType="WingtipToys.Models.Product" 
                    ...
                    DataTextField="ProductName" DataValueField="ProductID" BackColor="White" ForeColor="Black" Height="16px" Width="144px" >
                </asp:DropDownList>
            </td>
        </tr>
    </table>
