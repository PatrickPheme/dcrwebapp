...
namespace WingtipToys.Admin.Installation
{
    public partial class Delete : System.Web.UI.Page
    {
        ...
        // This is the Delete methd to delete the selected Installation item
        ...
        // This is the Select methd to selects a single Installation item with the id
        ...
        public WingtipToys.Models.Installation GetItem([FriendlyUrlSegmentsAttribute(0)]int? JobId)
        {
            ...
            using (_db)
            {
	            return _db.Installations.Where(m => m.JobId == JobId).Include(m => m.BookStatus).Include(m => m.Order).FirstOrDefault();
            }
        }
